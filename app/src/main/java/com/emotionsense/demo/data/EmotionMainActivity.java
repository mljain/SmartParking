...
import smartparking.smartparking.R;

public class EmotionMainActivity extends Activity implements DataUploadCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_emotion_main);
    ...
    public void onDataUploaded()
    {
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                Toast.makeText(EmotionMainActivity.this, "Data transferred.", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onDataUploadFailed()
    {
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                Toast.makeText(EmotionMainActivity.this, "Error transferring data", Toast.LENGTH_LONG).show();
            }
        });
    }
}
